      ...
      <section className="py-[var(--spacing-section)] px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <ScrollReveal>
              <div>
                <h2 className="font-[family-name:var(--font-heading)] text-3xl mb-8">
                  {t("sendMessage")}
                </h2>
                <form className="space-y-6" action="#" method="POST">
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        name="name"
                        required
                        className="w-full px-4 py-3 border border-[var(--color-border)] rounded-sm focus:outline-none focus:border-[var(--color-accent)] transition-colors bg-transparent"
                      />
                    </div>
                    <div>
                  ...
                  <button
                    type="submit"
                    className="px-8 py-4 bg-[var(--color-accent)] text-[var(--color-primary-dark)] text-xs uppercase tracking-widest font-medium hover:bg-[var(--color-accent-light)] transition-all duration-[var(--duration-normal)] ease-[var(--ease-luxury)]"
                  >
                    {t("sendMessage")}
                  </button>
                </form>
            ...
            <ScrollReveal delay={0.2}>
              <div className="space-y-10">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4 p-6 border border-[var(--color-border)] rounded-sm">
                    <div className="w-12 h-12 flex items-center justify-center border border-[var(--color-accent)] rounded-full flex-shrink-0">
                ...
                {/* Google Maps Embed */}
                <div className="relative aspect-[4/3] rounded-sm overflow-hidden border border-[var(--color-border)]">
                  <iframe
